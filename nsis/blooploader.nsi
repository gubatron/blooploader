...
!define SMLVERSION "0.8"
!define PUBLISHER "MyBloop LLC"
!define SPECIALBUILD "0.8.0.0"
!define PRIVATEBUILD "0.8.0.0"
!define APPNAMEANDVERSION "${APPNAME} ${SMLVERSION}"
!define OUTFILENAME "${SHRTAPPNAME}-${SMLVERSION}.windows.exe"

!define SHRTDESCR1 "Upload and share files for free with infinite space."
...
!define MUI_UNICON "..\blooploader.ico"
